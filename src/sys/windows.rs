...
pub(crate) use winapi::shared::ws2ipdef::{
    ...
    IP_DROP_MEMBERSHIP, IP_ADD_SOURCE_MEMBERSHIP, IP_DROP_SOURCE_MEMBERSHIP, IP_MREQ_SOURCE as IpMreqSource,
    IP_MREQ as IpMreq, IP_MULTICAST_IF, IP_MULTICAST_LOOP, IP_MULTICAST_TTL,
    IP_TOS, IP_TTL,
};
